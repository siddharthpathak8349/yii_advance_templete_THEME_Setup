            ...
            <div class="main-header-left ">
                <div class="responsive-logo">
                    <a href="index.html" class="header-logo">
                        <img src="/images/login-img/logo.png" class="mobile-logo logo-1" alt="logo">
                        <img src="/images/login-img/SPIDER.png" class="mobile-logo dark-logo-1" alt="logo">
                    </a>
                </div>
                ...
                <!-- <div class="main-header-center ms-4 d-sm-none d-md-none d-lg-block form-group" style="left: 240px;" >
                ...
                <div class="mb-0 navbar navbar-expand-lg navbar-nav-right responsive-navbar navbar-dark p-0">
                    <div class="collapse navbar-collapse" id="navbarSupportedContent-4">
                        <ul class="nav nav-item header-icons navbar-nav-right ms-auto">
                            ...
                            <li class="dropdown main-profile-menu nav nav-item nav-link ps-lg-2">
                                <a class="new nav-link profile-user d-flex" href="" data-bs-toggle="dropdown"><img alt="" src="/images/login-img/spider.png" class=""></a>
                                <div class="dropdown-menu" style="margin-left: -191px; margin-top:11px; background-color:  white !important ; ">
                                    <div class="menu-header-content p-3 border-bottom">
                                        <div class="d-flex wd-100p">
                                            <div class="main-img-user"><img alt="" src="/images/login-img/spider.png" class=""></div>
                                            <div class="ms-3 my-auto">
                                                <!-- < if ((\Yii::$app->user->identity) && (\Yii::$app->user->identity->id)) {
                                                ?>
                                                    <h6 class="tx-15 font-weight-semibold mb-0">< \Yii::$app->user->identity->name ?></h6>
                                                <?php  ?> -->
                                            </div>
                                        </div>
                                    </div>
                                    <a class="dropdown-item" href="<?= \yii\helpers\Url::toRoute(['/site/logout']); ?>" data-method="post"><svg xmlns="http://www.w3.org/2000/svg" class="me-2" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" width="15" height="15" x="0" y="0" viewBox="0 0 32 32" style="enable-background:new 0 0 512 512" xml:space="preserve" class="">
                                            <g>
                                                <g data-name="Layer 13">
                                                    <path d="m16.48 19.03 1.41 1.41L22.34 16l-4.45-4.44-1.41 1.41L18.51 15H4.41v2h14.1z" fill="#0a1e63" data-original="#000000" class=""></path>
                                                    <path d="M15.84.47v2h10.75v27.06H15.84v2h12.75V.47z" fill="#0a1e63" data-original="#000000" class=""></path>
                                                </g>
                                            </g>
                                        </svg> Log Out</a>
                                    <!-- <a class="dropdown-item" href="signup.html"><i class="far fa-arrow-alt-circle-left"></i> Sign Out</a> -->
